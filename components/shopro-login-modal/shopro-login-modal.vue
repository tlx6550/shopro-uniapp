<template>
    ...
    <view
        class="cu-modal"
        v-if="showLogin && !screenShot"
        :class="[{ show: showLogin }, modalType]"
        cathctouchmove
        @tap="hideModal"
    >
        <view
        ...
        >
            <view class="modal-box">
                <image
                    class="head-bg"
                    :src="$IMG_URL + '/imgs/nologin_bg.png'"
                    mode=""
                ></image>
                <view class="detail">
    ...
    <view
        ...
        v-if="forceOauth || showLogin"
    >
        <image
            class="logo-bg"
            :src="$IMG_URL + '/imgs/logo_bg.png'"
            mode="aspectFill"
        ></image>
